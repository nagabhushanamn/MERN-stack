                        ...
                        <div className="col-9">
                            ...
                            <ul style={{ margin: '10px 0px 10px' }} className="nav nav-tabs">
                                <li className="nav-item">
                                    <a onClick={e => this.changeTab(1, e)} className={tab === 1 ? 'nav-link active' : 'nav-link'} href="/">Overview</a>
                                </li>
                                <li className="nav-item">
                                    <a onClick={e => this.changeTab(2, e)} className={tab === 2 ? 'nav-link active' : 'nav-link'} href="/">Syllabus</a>
                                </li>
                                <li className="nav-item">
                                    <a onClick={e => this.changeTab(3, e)} className={tab === 3 ? 'nav-link active' : 'nav-link'} href="/">Reviews</a>
                                </li>
                            </ul>
